...
class PaginationTest extends TestCase
{
    public function testInvalid(): void
    {
        try {
            ...
            /* Expected */
            self::assertEquals('CurrentPage must be greater than 0', $e->getMessage());
        }
        ...
        try {
            ...
            /* Expected */
            self::assertEquals('PerPage must be greater than 0', $e->getMessage());
        }
        ...
        try {
            ...
            /* Expected */
            self::assertEquals('Total must be greater equals 0', $e->getMessage());
        }
    }
    ...
    public function testGetTotalPages(): void
    {
        ...
        self::assertEquals(1, $pagination->getTotalPages());

        $pagination = new Pagination(1, 1, 2);
        self::assertEquals(2, $pagination->getTotalPages());
    ...
    public function testGetCurrentPage(): void
    {
        ...
        self::assertEquals(42, $pagination->currentPage);
    }

    public function testGetTotal(): void
    {
        $pagination = new Pagination(1, 2, 42);
        self::assertEquals(42, $pagination->total);
    }
